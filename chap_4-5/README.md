# 1. 트랙바의 위치를 콘솔창에 출력하고 트랙바를 움직일때마다 트랙바의 위치값을 반지름으로 하는 원을 그리시오
...
# 2. 폭 500, 높이 500 픽셀의 3 채널 컬러영상에 트랙바를 생성하여 0~3 의 범위를 갖도록 하고 트렉바의 의치에 따라 각각 다른 동작을 수행하라.
...
https://youtube.com/shorts/YWNe7vm4Ko8
